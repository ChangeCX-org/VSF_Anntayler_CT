          ...
          <div class="collected-product-list">
            <transition-group name="fade" tag="div">
              <SfCollectedProduct
                ...
                image-width="180"
                image-height="200"
                @click:remove="wishlistremove({ product })"
...
export default {
  ...
  setup() {
    ...
    const wishlistremove =(product)=>{removeItem(product);
    analytics.track("Product Removed from Wishlist", {     
       "name": product.product.name,
        ...
        "sku": product.product.variant.sku,
        "url": product.product.variant.slug,
        "variant": "",
        "wishlist_id": product.product.id.toString(),
        "wishlist_name": ""
    })
    }
    onSSR(async () => {
