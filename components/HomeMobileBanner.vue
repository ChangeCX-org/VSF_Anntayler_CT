<template>
  <SfBanner
    :image="content[0].mobilebanner.mobileimage.url"
    :subtitle="content[0].mobilebanner.subtitle"
    :title="content[0].mobilebanner.title"
  ...
  >
    <template #call-to-action>
      <div class="banner-app__call-to-action">
        ...
        >
          <SfImage
            :src="content[0].mobilebanner.appimage.url"
            alt="App store"
          />
        </SfButton>
        <SfButton
        ...
        >
          <SfImage
            :src="content[0].mobilebanner.googleimage.url"
            alt="Google play"
          />
        </SfButton>
      </div>
