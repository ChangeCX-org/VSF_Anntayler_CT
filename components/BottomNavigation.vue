...
<!-- TODO: create logic with isActive prop for BottomNavigationItems -->
  <SfBottomNavigation class="navigation-bottom smartphone-only">
    ...
    <SfBottomNavigationItem icon="menu" size="20px" label="Menu" @click="toggleMenuSlideBar"/>
...
export default {
  ...
  setup(props, { root }) {
    const { toggleCartSidebar, toggleWishlistSidebar, toggleLoginModal,toggleMenuSlideBar } = useUiState();
