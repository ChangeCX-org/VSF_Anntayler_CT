...
<div>
    ...
    <div class="highlighted promo-code">
      ...
      />
      <SfButton class="promo-code__button" @click="() => couponapply({ couponCode: promoCode })">{{ $t('Apply') }}</SfButton>
    </div>
    <div class="highlighted">
      <SfCharacteristic
...
export default {
  ...
  setup () {
    ...
    const shipping = computed(() => cartGetters.getShippingPrice(cart.value));
    ...
    const couponapply =(coupon) =>{
      ...
      analytics.track("Coupon Entered", {
        order_id:'',
        coupon_id:'',
        coupon_entered:coupon.couponCode
      });
    };
    return {
      couponapply,
      ...
      characteristics: [
        ...
        },
        {
          title: 'Easy shipping',
          description:
            'You will receive dispatch confirmation and an arrival date',
          icon: 'shipping'
        },
        {
