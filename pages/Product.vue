      ...
      <div class="product__info">
        ...
        <div>
          ...
          <SfAddToCart
            ...
            @click="addtocartproduct({ product, quantity: parseInt(qty) })"
          />
        </div>
...
import { useProduct, useCart, productGetters, useReview, reviewGetters } from '@vsf-enterprise/commercetools';
...
export default {
  ...
  mounted(){
      window.analytics.track("Product Viewed",
      {
        ...
        "category": "",
        "coupon": "",
        "image_url":productGetters.getCoverImage(this.product) ,
        "name": productGetters.getName(this.product),
        "position": parseInt(0,10),
        "price": parseInt(productGetters.getPrice(this.product).regular,10),
        "product_id": productGetters.getId(this.product),
        "quantity": parseInt(0,10),
        "sku": "",
        "url": productGetters.getSlug(this.product) ,
        "variant": ""
      });
  },
  setup(props, context) {
